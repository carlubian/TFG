...
{
    public sealed partial class PanelSensorEditarStep3 : ContentDialog
    {
        private Sensor sensor;

        public PanelSensorEditarStep3(Sensor sensor)
        {
        ...
        {
            sensor.Pais = this.ComboPais.SelectedItem.ToString();
            this.Hide();
